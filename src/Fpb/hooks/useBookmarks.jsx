...
export const useBookmarks = () => {
  ...
  const restoreBookmark = useCallback(idx => {
...
const bookmark1 = {
  ...
  data: {
    ...
    rendering: {
      projection: 1, opacity: 0.5, intensity: 1, threshold: 0.2,
    }
  },
...
const bookmark2 = {
  ...
  data: {
    ...
    rendering: {
      projection: 0, opacity: 1, intensity: 1.5, threshold: 0.1,
    }
  },
  caption: "A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. A long interesting caption about this interesting data. ",
  target: {moveTime: 0, moveType: "linear"}
}
